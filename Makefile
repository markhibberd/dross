...
PUBLISH_WWW = web@mth.io:dross.mth.io/data
PUBLISH_RELEASE = web@mth.io:dross.mth.io/data/release/.
...
test: compile
	...
	scala -cp ${CP_TEST} io.mth.dross.DrossTest && \
...
doc: ${DOC_PROD}
	...
	find io -name "*.scala" | xargs -s 30000 \
		scaladoc \
			...
			-doc-version ${VERSION} \
			-doc-source-url http://dross.mth.io/release/${VERSION}/doc/xray/prod \
